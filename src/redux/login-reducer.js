...
export const LoginTC = createAsyncThunk("login/LoginTC", (params, {dispatch, rejectWithValue}) => {
        ...
        if (params.userName === "Admin" && params.password === "12345678") {
            ...
            dispatch(setLoginErrorAC({loginError: "The username or password is entered incorrectly. Try again :)"}))
...
export const LogoutTC = createAsyncThunk("login/LogoutTC", (params, {dispatch}) => {
